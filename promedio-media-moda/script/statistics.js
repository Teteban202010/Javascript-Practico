...
const addArrayPromedio = () => {
  ...
  itemsResult.innerText =
    "Tu lista actual lleva: (" +
    listaPromedio +
    ") si es correcto, presiona el boton Calcular Promedio";
};
...
const limpiarPromedio = () => {
  document.getElementById("inputPromedioNumero").value = "";
  document.getElementById("listPromedio").innerText = "";
  document.getElementById("resultPromedio").innerText = "";
}
...
const calcularModa = () => {
  ...
  const listaArray = Object.entries(listaContador).sort(function (
    elementoA,
    elementoB
  ) {
